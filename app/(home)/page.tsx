  ...
  return (
    <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col justify-center px-6 py-16">
      <p className="mb-3 text-sm uppercase tracking-widest text-accent">
        Reusable AI assets · Workshop platform
      </p>
      ...
      <p className="mb-8 max-w-prose text-lg text-fd-muted-foreground">
        A personal, reusable library of Claude skills, subagents, prompts, and
        configs — that also doubles as an adaptive workshop platform for mixed
        audiences. Set in the <em>Broadsheet</em> design system.
      </p>
